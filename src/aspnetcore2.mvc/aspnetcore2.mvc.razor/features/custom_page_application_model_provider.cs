...
namespace AspnetCore2.Mvc.Razor.Features
{
    /// <summary>
    /// Classe que cria um novo padrao de action para as páginas
    /// Necessario herdar da classe base DefaultPageApplicationModelProvider
    /// </summary>
    public class CustomPageApplicationModelProvider : DefaultPageApplicationModelProvider
    {
